...
struct triangle_mesh : public hittable {
	...
	triangle_mesh(hittable_list &triangles, const double time0, const double time1) : tris(std::make_shared<bvh>(triangles,time0, time1)) {}
